...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    'ho_ten': 'Họ và tên',
    'sdt': 'Số điện thoại',
    'dia_chi_user': 'Địa chỉ',
    'cap_nhat_thanh_cong': 'Cập nhật thông tin thành công',
    'xac_nhan_cap_nhat': 'Xác nhận cập nhật',
    'ban_co_chac_cap_nhat': 'Bạn có chắc muốn cập nhật thông tin?',
    'email_khong_the_doi': 'Email không thể thay đổi',
    'vui_long_dang_nhap': 'Vui lòng đăng nhập',
    'can_dang_nhap_de_xem_trang': 'Bạn cần đăng nhập để xem trang này',
    'vui_long_dang_nhap_lai': 'Vui lòng đăng nhập lại',
    'dang_xu_ly': 'Đang xử lý',
    'thong_bao': 'Thông báo',
    'khong_co_thay_doi': 'Không có thay đổi nào để lưu',
    ...
    'quan_ly_thuc_don': 'Quản Lý Sản Phẩm',
    'them_nguoi_dung': 'Thêm Người Dùng',
    'tim_kiem_nguoi_dung': 'Tìm kiếm người dùng...',
    'them_mon_an': 'Thêm Sản phẩm',
    'tim_kiem_mon_an': 'Tìm kiếm  ...',
    ...
    'thong_tin_mon_an': 'Thông tin Sản phẩm',
    ...
    'hoan_thanh_status': 'Hoàn thành',
    'dang_xu_ly_status': 'Đang xử lý',
    'cho_xu_ly': 'Chờ xử lý',
    'da_huy': 'Đã hủy',
    ...
    'danh_sach_mon': 'Danh sách Sản phẩm',
  ...
  en: {
    ...
    'cap_nhat_thong_tin': 'Update Personal Information',
    'luu_thay_doi': 'Save Changes',
    'ho_ten': 'Full Name',
    'sdt': 'Phone Number',
    'dia_chi_user': 'Address',
    'cap_nhat_thanh_cong': 'Information updated successfully',
    'xac_nhan_cap_nhat': 'Confirm Update',
    'ban_co_chac_cap_nhat': 'Are you sure you want to update your information?',
    'email_khong_the_doi': 'Email cannot be changed',
    'vui_long_dang_nhap': 'Please Login',
    'can_dang_nhap_de_xem_trang': 'You need to login to view this page',
    'vui_long_dang_nhap_lai': 'Please login again',
    'dang_xu_ly': 'Processing',
    'thong_bao': 'Notification',
    'khong_co_thay_doi': 'No changes to save',
    'thanh_cong': 'Success',
    'xac_nhan': 'Confirm',
    ...
    'hoan_thanh_status': 'Completed',
    'dang_xu_ly_status': 'Processing',
    'cho_xu_ly': 'Pending',
    'da_huy': 'Cancelled',
    ...
    'don_gia': 'Price',
    'huy': 'Cancel',
    'loi_xac_thuc': 'Authentication Error',
    'phien_het_han': 'Your session has expired, please log in again',
    'dang_nhap_lai': 'Log in again',
    'dang_tai_thong_tin': 'Loading information...',
  },
};
