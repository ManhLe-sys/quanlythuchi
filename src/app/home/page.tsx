    ...
    <div className="container mx-auto px-4 py-8 text-gray-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <button
          ...
          className="bg-white/80 backdrop-blur-xl shadow-lg rounded-3xl p-6 border border-gray-100 hover:bg-gradient-to-r hover:from-[#3E503C]/5 hover:to-[#3E503C]/10 transition-all duration-200 text-left"
        >
          <div className="flex items-center gap-4">
            <div className="p-4 bg-[#3E503C]/10 rounded-full">
              <svg className="w-8 h-8 text-[#3E503C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="bg-white/80 backdrop-blur-xl shadow-lg rounded-3xl p-6 border border-gray-100 hover:bg-gradient-to-r hover:from-[#FF6F3D]/5 hover:to-[#FF6F3D]/10 transition-all duration-200 text-left"
        >
          <div className="flex items-center gap-4">
            <div className="p-4 bg-[#FF6F3D]/10 rounded-full">
              <svg className="w-8 h-8 text-[#FF6F3D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
